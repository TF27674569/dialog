...
class AlertController {
     ...
     * @param listener
     */
    public void setOnclickListener(int viewId, AlertDialog.DialogClickListener listener) {
    ...
    public static class AlertParams {
        ...
        // 存放点击事件
        public SparseArray<AlertDialog.DialogClickListener> mClickArray = new SparseArray<>();
        // 宽度
        ...
        public void apply(AlertController mAlert) {
            ...
            if (mViewLayoutResId != 0) {
                viewHelper = new DialogViewHelper(mContext, mViewLayoutResId,mDialog);
            }
